...
class Signaling {
  ...
  Future<String> createRoom(RTCVideoRenderer remoteRenderer) async {
    ...
    showSnackBar(text: 'Current room is $roomId - You are the caller!');
    ...
    roomRef.snapshots().listen((snapshot) async {
      ...
      if (peerConnection?.getRemoteDescription() != null &&
        ...
        // Check if the connection is in the "stable" state before setting the remote description
        if (peerConnection?.connectionState == 'stable') {
          showSnackBar(text: "Someone tried to connect");
          await peerConnection?.setRemoteDescription(answer);
          showSnackBar(text: answer.toString());
        } else {
          showSnackBar(
              text:
